...
class DeclListNode extends ASTnode {
    ...
    public void nameAnalysis(SymTable symTab, SymTable globalTab) {
        int curOffset = TableSym.getLocalOffset();
        ...
        TableSym.setLocalOffset(curOffset);
    }    
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("addu", Codegen.FP, Codegen.SP, 8); //possibly change
...
class StructDeclNode extends DeclNode {
    ...
    public TableSym nameAnalysis(SymTable symTab) {
        ...
        this.size = this.myDeclList.numDecl();
...
class IfElseStmtNode extends StmtNode {
    ...
    public void nameAnalysis(SymTable symTab) {
        myExp.nameAnalysis(symTab);
        symTab.addScope();
        int offset = TableSym.getLocalOffset();
        myThenDeclList.nameAnalysis(symTab);
        myThenStmtList.nameAnalysis(symTab);
        int exitOffset = TableSym.getLocalOffset();
        try {
            symTab.removeScope();
        } catch (EmptySymTableException ex) {
            System.err.println("Unexpected EmptySymTableException " +
        ...
        symTab.addScope();
        TableSym.setLocalOffset(offset);
        myElseDeclList.nameAnalysis(symTab);
        myElseStmtList.nameAnalysis(symTab);
        int exitOffset2 = TableSym.getLocalOffset();
        exitOffset = exitOffset < exitOffset2 ? exitOffset:exitOffset2;
        TableSym.setLocalOffset(exitOffset);
        try {
            symTab.removeScope();
        } catch (EmptySymTableException ex) {
            System.err.println("Unexpected EmptySymTableException " +
    ...
    public void codeGen() {
        ...
        myExp.genJumpCode(truelab, falselab);
        Codegen.genLabel(truelab);
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen() {
        String condlab = Codegen.nextLabel();
        String bodylab = Codegen.nextLabel();
        String donelab = Codegen.nextLabel();

        Codegen.genLabel(condlab);
        myExp.genJumpCode(bodylab, donelab);
        myStmtList.codeGen();

        Codegen.generate("b", condlab);
        Codegen.genLabel(donelab);
    }
...
class ReturnStmtNode extends StmtNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("b", functionName);
    }
...
abstract class ExpNode extends ASTnode {
    ...
    public void genJumpCode(String truelabel, String falselable) { }
    public void codeGen() { }
}
...
class AndNode extends LogicalExpNode {
    ...
    public void codeGen() {
        String rightlab = Codegen.nextLabel();
        ...
        Codegen.generate("beq", Codegen.T2, Codegen.T0, rightlab);

        Codegen.generate("and", Codegen.T0, Codegen.T0, Codegen.T1);
        Codegen.genPush(Codegen.T0);
        Codegen.generate("b", endlab);

        Codegen.genLabel(rightlab);
        Codegen.genPush(Codegen.T0);
...
class OrNode extends LogicalExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("li", Codegen.T2, 0);
        Codegen.generate("bne", Codegen.T2, Codegen.T0, rightlab);
